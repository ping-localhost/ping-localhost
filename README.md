...
- [gethomepage/homepage](https://github.com/gethomepage/homepage) ([v1.4.3](https://github.com/gethomepage/homepage/releases/tag/v1.4.3), 3 days ago) - A highly customizable homepage (or startpage / application dashboard) with Docker and service API integrations.
- [bambulab/BambuStudio](https://github.com/bambulab/BambuStudio) ([v02.02.00.68](https://github.com/bambulab/BambuStudio/releases/tag/v02.02.00.68), 6 days ago) - PC Software for BambuLab and other 3D printers
...
- [RealDeco/xiaozhi-esphome](https://github.com/RealDeco/xiaozhi-esphome) - Alternative code to use xiaozhi ai devices in esphome/home assistant. (3 days ago)
