...
- [ping-localhost/panda-status](https://github.com/ping-localhost/panda-status) ([1.3.1](https://github.com/ping-localhost/panda-status/releases/tag/1.3.1), 1 week ago) - Control your BigTreeTech Panda Status via Home Assistant
...
- [Prepare version 1.3.1](https://github.com/ping-localhost/panda-status/pull/27) on [ping-localhost/panda-status](https://github.com/ping-localhost/panda-status) (1 week ago)
- [Update README with configuration URL details](https://github.com/ping-localhost/panda-status/pull/26) on [ping-localhost/panda-status](https://github.com/ping-localhost/panda-status) (1 week ago)
- [Update README with version info](https://github.com/ping-localhost/panda-status/pull/25) on [ping-localhost/panda-status](https://github.com/ping-localhost/panda-status) (1 week ago)
- [fix: URL in configuration help description](https://github.com/ping-localhost/panda-status/pull/24) on [ping-localhost/panda-status](https://github.com/ping-localhost/panda-status) (1 week ago)
- [fix: Issue template](https://github.com/ping-localhost/panda-status/pull/23) on [ping-localhost/panda-status](https://github.com/ping-localhost/panda-status) (1 week ago)



#### ⭐ Recent Stars

- [koosoli/ESPHomeDesigner](https://github.com/koosoli/ESPHomeDesigner) - A visual drag-and-drop editor for ESPHome displays (E-Ink, OLED, LCD, Touch), running as a Home Assistant integration or a standalone web app. (5 days ago)
- [pdxlocations/contact](https://github.com/pdxlocations/contact) - A Console UI for Meshtastic (4 weeks ago)
