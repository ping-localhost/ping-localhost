...
- [gethomepage/homepage](https://github.com/gethomepage/homepage) ([v1.4.2](https://github.com/gethomepage/homepage/releases/tag/v1.4.2), 1 day ago) - A highly customizable homepage (or startpage / application dashboard) with Docker and service API integrations.
- [bambulab/BambuStudio](https://github.com/bambulab/BambuStudio) ([v02.02.00.68](https://github.com/bambulab/BambuStudio/releases/tag/v02.02.00.68), 3 days ago) - PC Software for BambuLab and other 3D printers
...
- [Added missing Belgium/French OID for SOD](https://github.com/ZeroPass/pymrtd/pull/8) on [ZeroPass/pymrtd](https://github.com/ZeroPass/pymrtd) (4 days ago)
