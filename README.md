...
- [ZeroPass/pymrtd](https://github.com/ZeroPass/pymrtd) - Python implementation of ICAO 9303 biometric passport standard (1 day ago)
...
- [gethomepage/homepage](https://github.com/gethomepage/homepage) ([v1.4.3](https://github.com/gethomepage/homepage/releases/tag/v1.4.3), 5 days ago) - A highly customizable homepage (or startpage / application dashboard) with Docker and service API integrations.
- [bambulab/BambuStudio](https://github.com/bambulab/BambuStudio) ([v02.02.00.68](https://github.com/bambulab/BambuStudio/releases/tag/v02.02.00.68), 1 week ago) - PC Software for BambuLab and other 3D printers
...
- [Added missing Belgium/French OID for SOD](https://github.com/ZeroPass/pymrtd/pull/8) on [ZeroPass/pymrtd](https://github.com/ZeroPass/pymrtd) (1 week ago)
...
- [fix: autobrr description](https://github.com/runtipi/runtipi-appstore/pull/4668) on [runtipi/runtipi-appstore](https://github.com/runtipi/runtipi-appstore) (11 months ago)



#### ⭐ Recent Stars

- [RealDeco/xiaozhi-esphome](https://github.com/RealDeco/xiaozhi-esphome) - Alternative code to use xiaozhi ai devices in esphome/home assistant. (5 days ago)
