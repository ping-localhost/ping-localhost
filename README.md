...
- [bambulab/BambuStudio](https://github.com/bambulab/BambuStudio) ([v02.02.01.58](https://github.com/bambulab/BambuStudio/releases/tag/v02.02.01.58), 1 day ago) - PC Software for BambuLab and other 3D printers
- [gethomepage/homepage](https://github.com/gethomepage/homepage) ([v1.4.6](https://github.com/gethomepage/homepage/releases/tag/v1.4.6), 6 days ago) - A highly customizable homepage (or startpage / application dashboard) with Docker and service API integrations.
...
- [Added missing Belgium/French OID for SOD](https://github.com/ZeroPass/pymrtd/pull/8) on [ZeroPass/pymrtd](https://github.com/ZeroPass/pymrtd) (4 weeks ago)
